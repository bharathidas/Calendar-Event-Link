...
**Dependencies:**
Every release ships the module as `CalendarEventLink.mpk`. Where a version-tagged copy sits beside it, that is the same package under a longer name.
• Mendix Studio Pro 11.12.1 — release V3.0.0 (also `CalendarEventLink_1.2.0_Mx11.12.1.mpk`)
• Mendix Studio Pro 10.24.17 — release V2.0.0 (also `CalendarEventLink_1.1.0_Mx10.24.17.mpk`)
• Mendix modeler 9.12.4 — release V1.0.0
...
This is the length of time the event takes. It could be specified in hours, minutes, days, weeks, months, years, or other time units, depending
on the event's nature.
...
This question is about whether the event should be marked as a busy or occupied time slot on the calendar. A "busy" event typically indicates
unavailability during that time.
...
This is a web link that can direct users to a document or webpage related to the event, such as an agenda, RSVP page, or additional
information.

**Issues, suggestions and feature requests**
https://github.com/bharathidas/Calendar-Event-Link/issues
